...
def main():
    print("Opening gym_environement :", 'CartPole-v0')
    env = gym.make('CartPole-v0')
    print("Successfully open the environement :", 'CartPole-v0')
    gamma = 0.99
    copy_step = 25
    ...
    for n in range(N):
        ...
        if (n+1) % 100 == 0:
            print("episode:", n+1,"/", N, ", episode reward:", total_reward, ", eps:", epsilon, ", avg reward (last 100):", avg_rewards)
    env.close()
